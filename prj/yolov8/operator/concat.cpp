...
std::vector<std::vector<std::vector<std::vector<float>>>> concat(
    ...
    size_t batch_size = tensors[0].size();
    size_t ref_channels = tensors[0][0].size();
    size_t ref_height = (ref_channels > 0) ? tensors[0][0][0].size() : 0;
    size_t ref_width = (ref_height > 0 && ref_channels > 0) ? tensors[0][0][0][0].size() : 0;
    ...
    size_t tensor_channels = tensor[0].size();
    size_t tensor_height = tensor[0][0].size();
    size_t tensor_width = (tensor_height > 0) ? tensor[0][0][0].size() : 0;
