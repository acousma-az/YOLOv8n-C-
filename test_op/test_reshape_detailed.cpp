...
// 加载目标形状
std::vector<int> load_target_shape(const std::string& filename) {
...
void test_reshape_case1() {
    std::cout << "\n=== 测试案例1: 默认reshape (添加batch维度) ===" << std::endl;
    
    try {
        auto input = NpyLoader::load_3d_float32("reshape_case1_input.npy");
        auto expected_result = NpyLoader::load_4d_float32("reshape_case1_result.npy");
        auto target_shape = load_target_shape("reshape_case1_target_shape.npy");
        ...
        // 执行C++ reshape
        auto cpp_result = reshape_3d_to_4d(input, target_shape);
        ...
        // 详细对比
        bool match = detailed_compare_4d(cpp_result, expected_result, "默认reshape");
...
void test_reshape_case2() {
    std::cout << "\n=== 测试案例2: 指定4D形状 - 常规reshape ===" << std::endl;
    
    try {
        auto input = NpyLoader::load_3d_float32("reshape_case2_input.npy");
        auto expected_result = NpyLoader::load_4d_float32("reshape_case2_result.npy");
        auto target_shape = load_target_shape("reshape_case2_target_shape.npy");
        
        std::cout << "输入形状: [" << input.size() << ", " << input[0].size() << ", " 
                  << input[0][0].size() << "]" << std::endl;
        std::cout << "目标形状: [" << target_shape[0] << ", " << target_shape[1] << ", " 
                  << target_shape[2] << ", " << target_shape[3] << "]" << std::endl;
        ...
        // 详细对比
        bool match = detailed_compare_4d(cpp_result, expected_result, "指定4D形状");
...
// 测试案例3: 包含-1的自动推断
void test_reshape_case3() {
    std::cout << "\n=== 测试案例3: 包含-1的自动推断 ===" << std::endl;
    
    try {
        auto input = NpyLoader::load_3d_float32("reshape_case3_input.npy");
        auto expected_result = NpyLoader::load_4d_float32("reshape_case3_result.npy");
        auto target_shape = load_target_shape("reshape_case3_target_shape.npy");
        ...
        // 详细对比
        bool match = detailed_compare_4d(cpp_result, expected_result, "-1自动推断");
...
// 测试案例4: 大尺寸测试
void test_reshape_case4() {
    std::cout << "\n=== 测试案例4: 大尺寸测试 ===" << std::endl;
    
    try {
        auto input = NpyLoader::load_3d_float32("reshape_case4_input.npy");
        auto expected_result = NpyLoader::load_4d_float32("reshape_case4_result.npy");
        auto target_shape = load_target_shape("reshape_case4_target_shape.npy");
        ...
        // 详细对比
        bool match = detailed_compare_4d(cpp_result, expected_result, "大尺寸测试");
...
int main() {
    std::cout << "=== Reshape 3D to 4D 算子详细数值对比测试 ===" << std::endl;
